...
### 📈 ETF 브리핑
- **매일**: 신규 상장 ETF 감지 시 당일 상세 리포트 (종목명, 현재가, NAV, 시총)
- **매주 첫 거래일**: 주간 신규 ETF 요약 + 거래량 TOP 5
- **매월 첫 거래일**: 3개월 수익률 TOP/WORST 10 + 시가총액 TOP 10

### 🌍 외국인/기관 수급 추세 (매일 08:20)
- 최근 7일간 외국인·기관 순매수가 **꾸준히 증가**하는 종목을 추려서 알림
